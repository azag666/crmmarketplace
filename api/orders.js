  ...
  if (req.method === 'GET') {
    ...
    try {
      ...
      if (startDate && endDate) {
        ...
        // Filtra pela DATA REAL (creation_date)
        query = await sql`
      ...
      for (const order of orders) {
        await sql`
          INSERT INTO closings (
            ...
            creation_date, paid_at, seller_voucher, shopee_voucher, coins_cashback, reverse_shipping_fee
          ) VALUES (
            ...
            ${order.seller_voucher || 0}, ${order.shopee_voucher || 0}, 
            ${order.coins_cashback || 0}, ${order.reverse_shipping_fee || 0}
          )
          ...
          DO UPDATE SET 
            ...
            shopee_voucher = EXCLUDED.shopee_voucher,
